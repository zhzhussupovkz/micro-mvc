...
/**
 * Generated by PHPUnit_SkeletonGenerator 1.2.1 on 2013-10-02 at 18:45:04.
 */
class MongoModelTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->class = new ReflectionClass('MongoModel');
    }
    ...
    public function testDb() {
        $this->assertClassHasAttribute('db', 'MongoModel');
        $this->assertInstanceOf('MongoDB', $this->getProperty('db'));
    }
}
